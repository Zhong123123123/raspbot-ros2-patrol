...
def generate_launch_description():
    ...
    voice_announce_config = os.path.join(vision_share, 'config', 'voice_announce.yaml')
    remote_notify_config = os.path.join(vision_share, 'config', 'remote_notify.yaml')
    ...
    return LaunchDescription([
        ...
        Node(package='raspbot_vision', executable='voice_announce_node', name='raspbot_voice_announce', output='screen', parameters=[voice_announce_config]),
        ...
        Node(package='raspbot_vision', executable='remote_notify_node', name='raspbot_remote_notify', output='screen', parameters=[remote_notify_config]),
    ])
