...
def generate_launch_description():
    ...
    line_tracker_config = os.path.join(base_share, 'config', 'line_tracker.yaml')
    ir_line_follow_config = os.path.join(base_share, 'config', 'ir_line_follow.yaml')
    ...
    return LaunchDescription([
        ...
        Node(package='raspbot_base', executable='line_tracker_node', name='raspbot_line_tracker', output='screen', parameters=[line_tracker_config]),
        ...
        Node(package='raspbot_base', executable='ir_line_follow_node', name='raspbot_ir_line_follow', output='screen', parameters=[ir_line_follow_config]),
    ])
